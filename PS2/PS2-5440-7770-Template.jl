...
#Generally, the less number of times a metabolite appears in a reaction, the reaction frequency is less. The less connected a reaction is, the smallter the reaction frequency in the extreme pathways. 
...
# 4 reactions
rank_tied1=species_array[5],species_array[6],species_array[8],species_array[10],species_array[11],species_array[12],species_array[16]

# ╔═╡ 78d7ac07-ae4a-4117-a828-be84afa33805
#3 reactions
rank_tied2=species_array[4]
...
# ╔═╡ 7474ae31-0eeb-497c-8d82-0308d2f2b043
	number=sum(P, dims=1)

# ╔═╡ 84f07ac0-9c44-4fbd-86c2-21e267477ea7
begin
	#reaction frequency
	frequency=sum(P, dims=1)/size(P)[1]
	Print(frequency)
end
